...
public class MainMenuState extends BasicGameState
{
	...
	private int						stateID;				// Identifier von
															// diesem
															// BasicGameState
			...
			throws SlickException
	{
		...
		background.addComponent(
				new ImageRenderComponent(new Image("/assets/menu.png"))); // Bildkomponente
		...
		new_Game_Entity.addComponent(
				new ImageRenderComponent(new Image("assets/entry.png")));
